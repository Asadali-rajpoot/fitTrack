...
export default function HeroSection() {
  ...
  return (
    <div className="h-screen relative w-full bg-hero-bg flex flex-col bg-cover bg-black px-10">
      <Navbar />
      {/* hero content */}
      <div className="w-[520px] absolute top-1/2 -translate-y-1/2 flex flex-col gap-10 ">
        {/* hero heading */}
        <h1 className="text-[#e0e0e0] font-RubikFont font-bold text-7xl">
        ...
        {/* hero button */}
        <Button className="bg-white hover:bg-white/80 text-[#212121] font-RubikFont font-semibold text-sm py-6 px-8 w-fit">
          Get Started
        </Button>
